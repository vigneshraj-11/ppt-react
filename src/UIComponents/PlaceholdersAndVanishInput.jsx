...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={`searchElement w-200 relative max-w-xl mx-auto bg-white dark:bg-zinc-800 h-10 rounded-full overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-2000 ${
        value && "bg-gray-50"
      }`}
